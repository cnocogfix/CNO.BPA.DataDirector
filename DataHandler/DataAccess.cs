    ...
    public class DataAccess : IDisposable
    {
        ...
        public DataAccess()
        {
            ...
            _xmlParser = new CNO.BPA.Framework.XML.Parser(_applicationData
               + @"\Emc\InputAccel\Custom\Bin\datadirector.xml");
        ...
        public void insertBatchIssue(string batchNo, string item, int frequency)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_app_name",
                   "DD", OracleDbType.Varchar2, ParameterDirection.Input, cmd);
            ...
            try
            {
                ...
                if (CP.BatchItemID == 0)
                {
                    DBUtilities.CreateAndAddParameter("p_in_action_indicator",
                      "I", OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                }
                else
                {
                    DBUtilities.CreateAndAddParameter("p_in_action_indicator",
                    ...
                    DBUtilities.CreateAndAddParameter("p_in_item_id",
                      CP.BatchItemID, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                }
                DBUtilities.CreateAndAddParameter("p_in_app_name",
                  "DD", OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_machine_name",
                ...
                DBUtilities.CreateAndAddParameter("p_in_user_id",
                  ...
                  OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_batch_no",
                  CP.BatchNo, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_f_doc_xref",
                  CP.CurrentNodeID, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_dd_item_seq",
                  CP.DDItemSeq, OracleDbType.Int32, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_template_name",
                 CP.TemplateName, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                ...
                //  CP.FDocClassName, OracleDbType.Varchar2, ParameterDirection.Input, cmd);

                DBUtilities.CreateAndAddParameter("p_in_document_type",
                  CP.DocType, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_lob",
                  CP.LineOfBusiness, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_img_count",
                  CP.ImgCount, OracleDbType.Int32, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_certified_no",
                  CP.CertifiedNo, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_business_area",
                  CP.BusinessArea, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_work_type",
                  CP.WorkType, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_system_id",
                  CP.SystemID, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_company_code",
                  CP.CompanyCode, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_fax_id",
                  CP.FaxID, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_fax_sender",
                  CP.FaxFrom, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_fax_recipient",
                  CP.FaxTo, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_fax_server",
                  CP.FaxServer, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_fax_account",
                  CP.FaxAccount, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_fisdocid",
                  CP.FisDocID, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_work_category",
                  CP.WorkCategory, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                //we need to send in counts for standard claims... values default to 0
                DBUtilities.CreateAndAddParameter("p_in_hcfa_count",
                  CP.CountHCFA, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_ub_count",
                  CP.CountUB92, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_pheomb_count",
                  CP.CountPHEOMB, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_eomb_count",
                  CP.CountEOMB, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_attachment_count",
                  CP.CountAttachment, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                //we also need to send in the route code and type of bill for claims
                DBUtilities.CreateAndAddParameter("p_in_route_code",
                  CP.RouteCode, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_type_of_bill",
                  CP.TypeOfBill, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                ...
                DBUtilities.CreateAndAddParameter("p_in_validation_complete",
                  DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss"), OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                if (CP.ValidationStart.Length > 0)
                {
                    DBUtilities.CreateAndAddParameter("p_in_validation_start",
                       CP.ValidationStart, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                }
                DBUtilities.CreateAndAddParameter("p_in_received_date",
                  CP.ReceivedDate, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_docustream_request_id",
                  CP.DocustreamRequestID, OracleDbType.Int32, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_kicker_request_id",
                  CP.AWDRequestID, OracleDbType.Int32, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_case_id",
                  CP.AWDCaseID, OracleDbType.Int32, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_transaction_id",
                  CP.AWDTranID, OracleDbType.Int32, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_source_id",
                  CP.AWDSourceID, OracleDbType.Int32, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_front_office_request_id",
                  CP.FORequestID, OracleDbType.Int32, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_third_party_request_id",
                  CP.TPRequestID, OracleDbType.Int32, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_fnp8_docclassname",
                  CP.FNP8_DOCCLASSNAME, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_fnp8_objectstore",
                  CP.FNP8_OBJECTSTORE, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                ...
                DBUtilities.CreateAndAddParameter("p_out_item_id",
                   OracleDbType.Int32, ParameterDirection.Output, cmd);
                DBUtilities.CreateAndAddParameter("p_out_result",
                   OracleDbType.Varchar2, ParameterDirection.Output, 255, cmd);
                DBUtilities.CreateAndAddParameter("p_out_error_message",
                   OracleDbType.Varchar2, ParameterDirection.Output, 4000, cmd);
                ...
                {
                    //CP.BatchItemID = int.Parse(cmd.Parameters["p_out_item_id"].Value.ToString());
                    CP.BatchItemID = Convert.ToInt32((decimal)(OracleDecimal)(cmd.Parameters["p_out_item_id"].Value));
        ...
        public void createBatchItemReject(ref CommonParameters CP)
        {
            ...
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_reason_code",
                  CP.ReasonCode, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_process_step",
                  CP.ProcessStep, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                //END: AR 145620
                DBUtilities.CreateAndAddParameter("p_out_result",
                   OracleDbType.Varchar2, ParameterDirection.Output, 255, cmd);
                DBUtilities.CreateAndAddParameter("p_out_error_message",
        ...
        public void createDDItem(ref CommonParameters CP)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_user_id",
                  System.Environment.UserName.ToString(), OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_batch_no",
                  CP.BatchNo, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_f_doc_xref",
                  CP.CurrentNodeID, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                ...
                DBUtilities.CreateAndAddParameter("p_in_fnp8_folder",
                  CP.FNP8_FOLDER, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_current_status",
                  intCurrentStatus, OracleDbType.Int32, ParameterDirection.Input, cmd);
                ...
                else
                {
                    ...
                    CP.DDItemSeq = Convert.ToInt32((decimal)(OracleDecimal)(cmd.Parameters["p_out_dd_item_seq"].Value));
                }
        ...
        public void createDDItemIndex(int DDItemSeq, string indexName, string indexNameP8, string indexValue)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_user_id",
                  System.Environment.UserName.ToString(), OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_dd_item_seq",
                  DDItemSeq, OracleDbType.Int32, ParameterDirection.Input, cmd);
                if (indexName.Length > 0)
                {
                    DBUtilities.CreateAndAddParameter("p_in_index_name",
                        indexName, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                }
                if (indexNameP8.Length > 0)
                {
                    DBUtilities.CreateAndAddParameter("p_in_fnp8_index_name",
                        indexNameP8, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                }
                DBUtilities.CreateAndAddParameter("p_in_index_value",
                    indexValue, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_out_result",
                   OracleDbType.Varchar2, ParameterDirection.Output, 255, cmd);
                DBUtilities.CreateAndAddParameter("p_out_error_message",
                   OracleDbType.Varchar2, ParameterDirection.Output, 4000, cmd);
            ...
            try
            {
                if (CP.TrackUser)
                {
                    ...
                    DBUtilities.CreateAndAddParameter("p_in_app_machine",
                      Environment.MachineName, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                    DBUtilities.CreateAndAddParameter("p_in_batch_no",
                      CP.BatchNo, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                    DBUtilities.CreateAndAddParameter("p_in_node_id",
                      CP.CurrentNodeID, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                    DBUtilities.CreateAndAddParameter("p_in_user_id",
                      Environment.UserName, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                    DBUtilities.CreateAndAddParameter("p_in_action",
                      action, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                    DBUtilities.CreateAndAddParameter("p_in_fields_used",
                      fieldsUsed, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                    DBUtilities.CreateAndAddParameter("p_out_result",
                       OracleDbType.Varchar2, ParameterDirection.Output, 255, cmd);
                    DBUtilities.CreateAndAddParameter("p_out_error_message",
                       OracleDbType.Varchar2, ParameterDirection.Output, 4000, cmd);
        ...
        public void updateDDItem(ref CommonParameters CP)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_invoice_request_id",
                  CP.InvoiceRequestID, OracleDbType.Int32, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_current_status",
                  150, OracleDbType.Int32, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_out_dd_item_seq",
                   OracleDbType.Int32, ParameterDirection.Output, cmd);
                DBUtilities.CreateAndAddParameter("p_out_result",
                   OracleDbType.Varchar2, ParameterDirection.Output, 255, cmd);
        ...
        public void releaseDDItem(ref CommonParameters CP)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_dd_item_seq",
                  CP.DDItemSeq, OracleDbType.Int32, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_current_status",
                  200, OracleDbType.Int32, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_out_dd_item_seq",
                   OracleDbType.Int32, ParameterDirection.Output, cmd);
                DBUtilities.CreateAndAddParameter("p_out_result",
                   OracleDbType.Varchar2, ParameterDirection.Output, 255, cmd);
        ...
        public void getRouteCode(ref CommonParameters CP)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_site",
                   CP.SiteID, OracleDbType.Varchar2, ParameterDirection.Input, cmd);

                DBUtilities.CreateAndAddParameter("p_in_sort_code",
                   CP.SortCode, OracleDbType.Varchar2, ParameterDirection.Input, cmd);

                DBUtilities.CreateAndAddParameter("p_in_form_name",
                   CP.FormName, OracleDbType.Varchar2, ParameterDirection.Input, cmd);

                DBUtilities.CreateAndAddParameter("p_in_va_tin",
                   CP.ProviderTIN, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                ...
                DBUtilities.CreateAndAddParameter("p_in_policy_number",
                   CP.PolicyNo, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
        ...
        public void createDSTRequest(ref CommonParameters CP)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_site_id",
                  CP.SiteID, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_current_status",
                  100, OracleDbType.Int32, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_batch_no",
                  CP.BatchNo, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_received_date",
                  CP.ReceivedDate, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_scan_complete",
                  CP.ScanDate, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_box_no",
                  CP.BoxNo, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_route_code",
                  CP.RouteCode, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                ...
                DBUtilities.CreateAndAddParameter("p_in_policy_no",
                  CP.PolicyNo, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_img_count",
                  CP.ImgCount, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                ...
                else
                {
                    ...
                    //   .Value.ToString());
                    CP.DocustreamRequestID = Convert.ToInt32((decimal)(OracleDecimal)(cmd.Parameters["p_out_docustream_request_id"].Value));
                }
            }
            catch (Exception ex)
            {
        ...
        public void createFORequest(ref CommonParameters CP)
        {
            try
            {
                ...
                else
                {
                    ...
                    //    //converting param decimal value to int
                    //    CP.FORequestID = Convert.ToInt32((decimal)(OracleDecimal)(cmd.Parameters["p_out_front_office_request_id"].Value));
                    //}
                    if (cmd.Parameters["p_out_front_office_request_id"].Value.ToString().ToUpper() != "NULL")  //handling obj null; eliminates null exception [21.4]
                    {
                        CP.AWDTranID = Convert.ToInt32((decimal)(OracleDecimal)(cmd.Parameters["p_out_front_office_request_id"].Value));
                    }
        ...
        public void createInvoiceRequest(ref CommonParameters CP)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_user_id",
                  ...
                  OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_current_status",
                 // intCurrentStatus, OracleDbType.Number, ParameterDirection.Input, cmd);
                intCurrentStatus, OracleDbType.Int32, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_batch_no",
                  CP.BatchNo, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_f_doc_xref",
                ...
                else
                {
                    ...
                    //}
                    if (cmd.Parameters["p_out_invoice_request_id"].Value.ToString().ToUpper() != "NULL")  //handling obj null; eliminates null exception [21.4]
                    {
                        CP.InvoiceRequestID = Convert.ToInt32((decimal)(OracleDecimal)(cmd.Parameters["p_out_invoice_request_id"].Value));
                    }
                }
            }
            catch (Exception ex)
        ...
        public void createInvoiceDetail(ref CommonParameters CP)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_invoice_line_number",
                  1, OracleDbType.Int32, ParameterDirection.Input, cmd);
                ...
                DBUtilities.CreateAndAddParameter("p_in_uom",
                  "EACH", OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_unit_price",
                  CP.InvoiceTotal, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
        ...
        public void createTPRequest(ref CommonParameters CP)
        {
            try
            {
                ...
                else
                {
                    ...
                    //}
                    if (cmd.Parameters["p_out_third_party_request_id"].Value.ToString().ToUpper() != "NULL")  //handling obj null; eliminates null exception [21.4]
                    {
                        CP.TPRequestID = Convert.ToInt32((decimal)(OracleDecimal)(cmd.Parameters["p_out_third_party_request_id"].Value));
                    }
                                            ...
                                            int sourceID, string workType)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_priority",
                  CP.AWDPriority, OracleDbType.Int32, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_kicker_request_id",
                  CP.AWDRequestID, OracleDbType.Int32, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_case_id",
                  caseID, OracleDbType.Int32, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_transaction_id",
                  tranID, OracleDbType.Int32, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_source_id",
                  sourceID, OracleDbType.Int32, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_business_area",
                  CP.BusinessArea, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_work_type",
                  workType, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_awd_stat_code",
                  CP.AWDStatus, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_f_doc_xref",
                  CP.CurrentNodeID, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_source_type",
                  CP.AWDSourceType, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                ...
                else
                {
                    ...
                    if (cmd.Parameters["p_out_kicker_request_id"].Value.ToString().ToUpper() != "NULL")
                    {
                        //CP.AWDRequestID = Convert.ToInt32 (cmd.Parameters["p_out_kicker_request_id"].Value.ToString());
                        CP.AWDRequestID = Convert.ToInt32((decimal)(OracleDecimal)(cmd.Parameters["p_out_kicker_request_id"].Value));
                    }
                    else
                    {
                        CP.AWDRequestID = 0;
                    ...
                    if (cmd.Parameters["p_out_case_id"].Value.ToString().ToUpper() != "NULL")  //handling obj null; eliminates null exception [21.4]
                    {
                        //CP.AWDCaseID = (int)cmd.Parameters["p_out_case_id"].Value;
                        //if (Convert.ToInt32(cmd.Parameters["p_out_case_id"].Value.ToString()) ==0)
                        CP.AWDCaseID = Convert.ToInt32((decimal)(OracleDecimal)(cmd.Parameters["p_out_case_id"].Value));
                    ...
                    if (cmd.Parameters["p_out_transaction_id"].Value.ToString().ToUpper() != "NULL")  //handling obj null; eliminates null exception [21.4]
                    {
                        CP.AWDTranID = Convert.ToInt32((decimal)(OracleDecimal)(cmd.Parameters["p_out_transaction_id"].Value));
                    }
                    else
                    {
                        CP.AWDTranID = 0;
                    ...
                    if (cmd.Parameters["p_out_source_id"].Value.ToString().ToUpper() != "NULL")
                    {
                        //CP.AWDSourceID = (int)cmd.Parameters["p_out_source_id"].Value;
                        CP.AWDSourceID = Convert.ToInt32((decimal)(OracleDecimal)(cmd.Parameters["p_out_source_id"].Value));
                    }
                    else
                    {
                         CP.AWDSourceID = 0;
                ...
                if (value.Length > 0)
                {
                    ...
                    if (objectID > 0)
                    {
                        ...
                        DBUtilities.CreateAndAddParameter("p_in_lob_name",
                          name, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                        DBUtilities.CreateAndAddParameter("p_in_lob_value",
                          value, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                        DBUtilities.CreateAndAddParameter("p_in_record_type",
                          type, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                        DBUtilities.CreateAndAddParameter("p_in_kicker_object_id",
                           objectID, OracleDbType.Int32, ParameterDirection.Input, cmd);
                        DBUtilities.CreateAndAddParameter("p_out_result",
                           OracleDbType.Varchar2, ParameterDirection.Output, 255, cmd);
                        DBUtilities.CreateAndAddParameter("p_out_error_message",
                           OracleDbType.Varchar2, ParameterDirection.Output, 4000, cmd);
        ...
        public void getFISID(ref CommonParameters CP)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_batch_source_code",
                  CP.ScannerID, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_scanned_date",
                  tmpScanDate, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
            ...
            try
            {
                ...
                if (CP.WorkType.Length > 0)
                {
                    ...
                    DBUtilities.CreateAndAddParameter("p_out_f_docclassname",
                      OracleDbType.Varchar2, ParameterDirection.Output, 20, cmd);
                    DBUtilities.CreateAndAddParameter("p_out_document_type",
                      OracleDbType.Varchar2, ParameterDirection.Output, 10, cmd);
                    DBUtilities.CreateAndAddParameter("p_out_lob",
                      OracleDbType.Varchar2, ParameterDirection.Output, 3, cmd);
                    DBUtilities.CreateAndAddParameter("p_out_FNP8_DOCCLASSNAME",
                      OracleDbType.Varchar2, ParameterDirection.Output, 50, cmd);
                    DBUtilities.CreateAndAddParameter("p_out_FNP8_OBJECTSTORE",
                      OracleDbType.Varchar2, ParameterDirection.Output, 50, cmd);
                    DBUtilities.CreateAndAddParameter("p_out_FNP8_FOLDER",
                      OracleDbType.Varchar2, ParameterDirection.Output, 250, cmd);
                ...
                else//assume this is a case with source only
                {
                    ...
                    DBUtilities.CreateAndAddParameter("p_in_case_work_type",
                      CP.CaseWorkType, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                    DBUtilities.CreateAndAddParameter("p_out_f_docclassname",
                      OracleDbType.Varchar2, ParameterDirection.Output, 20, cmd);
                    DBUtilities.CreateAndAddParameter("p_out_document_type",
                      OracleDbType.Varchar2, ParameterDirection.Output, 10, cmd);
        ...
        public void getAWDLinkData(ref CommonParameters CP)
        {
            try
            {
                ...
                cmd.BindByName = true;
                DBUtilities.CreateAndAddParameter("p_in_dd_item_seq",
                  CP.DDItemSeqPrevious, OracleDbType.Int32, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_out_case_id",
                   OracleDbType.Int32, ParameterDirection.Output, cmd);
                   ...
                   .ToUpper() == "SUCCESSFUL")
                {
                    if (cmd.Parameters["p_out_case_id"].Value.ToString().Length > 0 )
                    {
                        ...
                        //if (!string.IsNullOrEmpty(cmd.Parameters["p_out_case_id"].Value.ToString()))
                        if (cmd.Parameters["p_out_case_id"].Value.ToString().ToUpper() != "NULL")
                        {
                            CP.AWDCaseIDPrevious = Convert.ToInt32((decimal)(OracleDecimal)(cmd.Parameters["p_out_case_id"].Value.ToString()));
                        }
                        //CP.AWDCaseIDPrevious = Convert.ToInt32((decimal)(OracleDecimal)(cmd.Parameters["p_out_case_id"].Value.ToString()));
                    }
                    if (cmd.Parameters["p_out_tran_id"].Value.ToString().Length > 0)
                    {
                        ...
                        if (cmd.Parameters["p_out_tran_id"].Value.ToString().ToUpper() != "NULL")
                        {
                            CP.AWDTranIDPrevious = Convert.ToInt32((decimal)(OracleDecimal)(cmd.Parameters["p_out_tran_id"].Value.ToString()));
                        }
                    }
                    ...
                    if (cmd.Parameters["p_out_kicker_request_id"].Value.ToString().Length > 0)
                    {
                        ...
                        if (cmd.Parameters["p_out_kicker_request_id"].Value.ToString().ToUpper() != "NULL")
                        {
                            CP.AWDRequestIDPrevious = Convert.ToInt32((decimal)(OracleDecimal)(cmd.Parameters["p_out_kicker_request_id"].Value.ToString()));
                        }
                    }
        ...
        public string getBundleFlag(ref CommonParameters CP)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_out_bundle",
                   OracleDbType.Varchar2, ParameterDirection.Output, 1, cmd);
                DBUtilities.CreateAndAddParameter("p_out_result",
                   OracleDbType.Varchar2, ParameterDirection.Output, 255, cmd);
                DBUtilities.CreateAndAddParameter("p_out_error_message",
                   OracleDbType.Varchar2, ParameterDirection.Output, 4000, cmd);
        ...
        public void lookupWorktypeBySortCode(ref CommonParameters CP)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_out_work_type",
                  OracleDbType.Varchar2, ParameterDirection.Output, 25, cmd);
                DBUtilities.CreateAndAddParameter("p_out_result",
                   OracleDbType.Varchar2, ParameterDirection.Output, 255, cmd);
                DBUtilities.CreateAndAddParameter("p_out_error_message",
                   OracleDbType.Varchar2, ParameterDirection.Output, 4000, cmd);
        ...
        public int validationVATIN(ref CommonParameters CP)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_out_tax_id",
                  OracleDbType.Varchar2, ParameterDirection.Output, 12, cmd);
                DBUtilities.CreateAndAddParameter("p_out_result",
                   OracleDbType.Varchar2, ParameterDirection.Output, 255, cmd);
                DBUtilities.CreateAndAddParameter("p_out_error_message",
                   OracleDbType.Varchar2, ParameterDirection.Output, 4000, cmd);
        ...
        public DataSet selectGroupDetails(ref CommonParameters CP)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_group_number",
                  CP.GroupNo.Replace("*", "%"), OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_group_name",
                  CP.GroupName.Replace("*", "%"), OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_m_group_number",
                  CP.MasterGroupID.Replace("*", "%"), OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_m_group_name",
                  CP.MasterGroupName.Replace("*", "%"), OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_out_ref_cursor",
                   DBNull.Value, OracleDbType.RefCursor, ParameterDirection.Output, cmd);
                DBUtilities.CreateAndAddParameter("p_out_result",
                   OracleDbType.Varchar2, ParameterDirection.Output, 255, cmd);
                DBUtilities.CreateAndAddParameter("p_out_error_message",
                   OracleDbType.Varchar2, ParameterDirection.Output, 4000, cmd);
        ...
        public string getBusinessAreaFromHolderNumber(ref CommonParameters CP)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_holder_number",
                  CP.HolderNumber, OracleDbType.Varchar2, ParameterDirection.Input, cmd);                                
        ...
        public DataSet selectPrivatePlacement(ref CommonParameters CP, string AsOfDate)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_cusip",
                  CP.AccountNumber, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_asofdate",
                  AsOfDate, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_out_ref_cursor",
                   DBNull.Value, OracleDbType.RefCursor, ParameterDirection.Output, cmd);
                DBUtilities.CreateAndAddParameter("p_out_result",
                   OracleDbType.Varchar2, ParameterDirection.Output, 255, cmd);
        ...
        public DataSet selectMortgage(ref CommonParameters CP, string Address)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_property_address",
                  Address, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_out_ref_cursor",
                   DBNull.Value, OracleDbType.RefCursor, ParameterDirection.Output, cmd);
                DBUtilities.CreateAndAddParameter("p_out_result",
                   OracleDbType.Varchar2, ParameterDirection.Output, 255, cmd);
        ...
        public DataSet selectRoutingChoices(string SiteID)
        {
            try
            {
                ...
                cmd.BindByName = true;
                DBUtilities.CreateAndAddParameter("p_in_site_id",
                  SiteID, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_out_ref_cursor",
                   DBNull.Value, OracleDbType.RefCursor, ParameterDirection.Output,
                   cmd);
                DBUtilities.CreateAndAddParameter("p_out_result",
        ...
        public void selectPopCodeLookupList(ref CommonParameters CP)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_pop_code",
                  CP.PopCode, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_out_ref_cursor",
                   DBNull.Value, OracleDbType.RefCursor, ParameterDirection.Output,
                   cmd);
                DBUtilities.CreateAndAddParameter("p_out_result",
        ...
        public string getSearchType(string SiteID, string WorkCategory)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_site_id",
                  SiteID, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_work_category",
                  WorkCategory, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
        ...
        public DataSet getRejectOptions(string OptionType)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_option_type",
                  OptionType, OracleDbType.Varchar2, ParameterDirection.Input, cmd);                
                DBUtilities.CreateAndAddParameter("p_out_ref_cursor",
                   DBNull.Value, OracleDbType.RefCursor, ParameterDirection.Output, cmd);
                DBUtilities.CreateAndAddParameter("p_out_result",
                   OracleDbType.Varchar2, ParameterDirection.Output, 255, cmd);
        ...
        public void updateReasonCode(string BatchNo, string FDocXref, string ReasonCode)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_batch_no",
                  BatchNo, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_f_doc_xref",
                  FDocXref, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_reason_code",
                  ReasonCode, OracleDbType.Varchar2, ParameterDirection.Input, cmd);                
                DBUtilities.CreateAndAddParameter("p_out_result",
                   OracleDbType.Varchar2, ParameterDirection.Output, 255, cmd);
                DBUtilities.CreateAndAddParameter("p_out_error_message",
                   OracleDbType.Varchar2, ParameterDirection.Output, 4000, cmd);
        ...
        public void selectContestableFromPlanCode(ref CommonParameters CP)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_plan_code",
                  CP.PlanCode, OracleDbType.Varchar2, ParameterDirection.Input, cmd);                
                DBUtilities.CreateAndAddParameter("p_out_contestable",
                  OracleDbType.Varchar2, ParameterDirection.Output, 5, cmd);
                DBUtilities.CreateAndAddParameter("p_out_result",
                   OracleDbType.Varchar2, ParameterDirection.Output, 255, cmd);
                DBUtilities.CreateAndAddParameter("p_out_error_message",
                   OracleDbType.Varchar2, ParameterDirection.Output, 4000, cmd);
        ...
        public string selectFrontOfficeBarcode(ref CommonParameters CP)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("P_IN_BFO_BARCODE_DOCUMENT_TYPE",
                  CP.DocTypeOrig, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
        ...
        public string selectFrontOfficeProdCatXref(ref CommonParameters CP)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("P_IN_PRODUCT_CATEGORY",
                  CP.ProductCategory, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("P_OUTPUT",
                   DBNull.Value, OracleDbType.RefCursor, ParameterDirection.Output,
                   cmd);
                DBUtilities.CreateAndAddParameter("p_out_result",
        ...
        public int selectPrivacyMailing(ref CommonParameters CP)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("P_IN_MASTER_ID",
                  CP.PrivMasterID, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("P_OUTPUT",
                   DBNull.Value, OracleDbType.RefCursor, ParameterDirection.Output,
                   cmd);
                DBUtilities.CreateAndAddParameter("p_out_result",
        ...
        public string selectSiteID(ref CommonParameters CP)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_admin_system_id",
                  CP.SystemNo, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_admin_company_code",
                  CP.CompanyNo, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_work_category",
                  CP.WorkCategory, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
        ...
        public void selectSortCodeFromPlanCode(ref CommonParameters CP)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_biceps_company_code",
                  CP.CompanyCodeBICPS, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_site_id",
                  CP.SiteID, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_out_sort_code",
                  OracleDbType.Varchar2, ParameterDirection.Output, 6, cmd);
                DBUtilities.CreateAndAddParameter("p_out_result",
                   OracleDbType.Varchar2, ParameterDirection.Output, 255, cmd);
                DBUtilities.CreateAndAddParameter("p_out_error_message",
                   OracleDbType.Varchar2, ParameterDirection.Output, 4000, cmd);
        ...
        public Point selectDDUserFormSettings(string formName)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_user_id",
                  System.Environment.UserName.ToString(), OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_form_name",
                  formName, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
        ...
        public void createDDUserFormSettings(string updatOrInsert, string formName, string formX, string formY)
        {
            try
            {
                ...
                cmd.BindByName = true;
                DBUtilities.CreateAndAddParameter("p_in_action_indicator",
                  updatOrInsert, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_user_id",
                  System.Environment.UserName.ToString(), OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_form_name",
                  formName, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_form_x",
                  formX, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_form_y",
                  formY, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_out_result",
                   OracleDbType.Varchar2, ParameterDirection.Output, 255, cmd);
                DBUtilities.CreateAndAddParameter("p_out_error_message",
                   OracleDbType.Varchar2, ParameterDirection.Output, 4000, cmd);
        ...
        public string selectDDMainDefinitionValue(string DefinitionType, string Name, string SiteID)
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_definition_type",
                  DefinitionType, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_name",
                  Name, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_site_id",
                  SiteID, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_out_value",
                  OracleDbType.Varchar2, ParameterDirection.Output, 100, cmd);
                DBUtilities.CreateAndAddParameter("p_out_result",
                   OracleDbType.Varchar2, ParameterDirection.Output, 255, cmd);
                DBUtilities.CreateAndAddParameter("p_out_error_message",
                   OracleDbType.Varchar2, ParameterDirection.Output, 4000, cmd);
                    ...
                    if (parameterName.Length != 0)
                    {
                        ...
                        //add parameter to command
                        {
                            DBUtilities.CreateAndAddParameter(parameterName,
                              parameterValue, OracleDbType.Varchar2, ParameterDirection.Input, cmd);

                        }
                        else  //handling null value passing to db. [21.4]
                        {
                            //parameterValue = Convert. DBNull.Value;
            ...
            try
            {
                ...
                foreach (DataRow dr in CP._MVIFieldData.DD_MVI_FIELD_DEFINITION.Rows)
                {
                    ...
                    if (parameterName.Length != 0)
                    {
                        ...
                        //add parameter to command
                        {
                            if (parameterName.ToUpper().Contains("DATE") == true)
                            { //converting date param to oracle type [21.4]
                                DateTime dtvalue = DateTime.Parse(parameterValue);
                                parameterValue = dtvalue.ToString("yyyy/MM/dd HH:mm:ss");
                            }
                            string MAX_Length = dr["MAX_LENGTH"].ToString();
                            if (MAX_Length.Length != 0)
                            {
                                if (parameterValue.Length > Int16.Parse(MAX_Length))
                                {
                                    parameterValue = parameterValue.Substring(0, Int16.Parse(MAX_Length));
                                }
                            }
                            DBUtilities.CreateAndAddParameter(parameterName,
                              parameterValue, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                        ...
                        /* commenting to check awdrequestid setting a value. [21.4]
                         * else
                        {
                            //parameterValue = Convert. DBNull.Value;
                            // setting dbnull to empty params [21.4]
